...
export default function RoomModal({
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            const newBooking = {
              ...
              paymentStatus: "PAID",
              addons: addons.map(
                (a) => luxuryAddons.find((la) => la.id === a)?.name || a,
              ),
            };
  ...
  const luxuryAddons = [
    ...
    {
      id: "spa",
      name: "Couples Wellness Spa Package",
      price: 9500,
      type: "per_stay",
    ...
    {
      id: "shuttle",
      name: "Airport Private Tesla Shuttle",
      price: 6000,
      type: "per_stay",
    ...
    {
      id: "late_checkout",
      name: "Connoisseur Late Checkout (4 PM)",
      price: 4000,
      type: "per_stay",
        ...
        <div className="md:col-span-5 bg-amber-950/40 text-amber-200 p-6 flex flex-col justify-between relative overflow-hidden border-b md:border-b-0 md:border-r border-white/5">
          ...
          <div className="space-y-6 relative z-10">
            ...
            <div className="flex items-center gap-1.5 pb-4 border-b border-white/5">
              ...
              <span className="font-display font-bold tracking-wider text-xs text-white">
                RESERVATION SUMMARY
              </span>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <h4 className="text-lg font-display text-white font-semibold">
                  {hotel.name}
                </h4>
              ...
              <div>
                ...
                <p className="text-xs font-light text-slate-300">
                  Suite {room.number} • Max {room.maxGuests} guests
                </p>
              </div>
              ...
              <div className="border-t border-white/5 pt-4 space-y-2 text-xs">
                <div className="flex justify-between">
                  <span className="text-slate-300 font-light">
                    {room.type} ({days} nights)
                  </span>
                  <span className="font-mono text-white">
                    ₹{(room.price * days).toLocaleString("en-IN")}
                  </span>
                </div>
                    ...
                    {addons.map((addonId) => {
                      ...
                      if (ad) {
                        return (
                          <div
                            key={addonId}
                            className="flex justify-between pl-2 border-l border-amber-500/20 text-[11px]"
                          >
              ...
              >
                <div>
                  <h3 className="text-xl font-display font-semibold text-white">
                    Customise Stay Parameters
                  </h3>
                  <p className="text-xs text-slate-400 font-light mt-0.5">
                    Select check-in dates, guest counters, and bespoke resort
                    amenities.
                  </p>
                </div>
                ...
                >
                  {user
                    ...
                    : "Guest Sign In to Complete Booking"}
                </button>
              </motion.div>
            )}
            ...
            {step === "PAYMENT" && (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-400 font-light mt-0.5">
                    Your bespoke luxury stay is guaranteed via sandbox secure
                    channels.
                  </p>
                </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-white/5 border border-white/5 rounded-xl p-3 text-center space-y-0.5">
                        ...
                        <span className="text-xs font-bold text-amber-400 font-mono tracking-wider select-all">
                          9182347763@ybl
                        </span>
                      </div>
                      <div className="bg-white/5 border border-white/5 rounded-xl p-3 text-center space-y-0.5">
                    ...
                    <div className="p-3 bg-white/5 border border-white/5 rounded-xl flex gap-2.5 items-start text-xs font-light text-slate-300 leading-relaxed">
                      ...
                      <div>
                        <span className="font-semibold text-slate-100 block">
                          Fast Automated Booking Gate
                        </span>
                        Scan this QR code using PhonePe, Google Pay, Paytm, or
                        any BHIM UPI mobile application. Once completed inside
                        your banking client, confirm payment execution below.
                      </div>
                    </div>
                      ...
                      <div className="bg-black/40 border border-amber-500/20 rounded-xl p-3 font-mono text-[10px] text-amber-400/90 space-y-1 bg-gradient-to-br from-amber-500/[0.02] to-transparent">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-bold text-slate-200 uppercase">
                            Handshake Telemetry Monitor
                          </span>
                        </div>
                        <p className="text-[11px] font-light mt-1 text-slate-300">
                          {upiStep}
                        </p>
                      </div>
                    )}
                  ...
                  <div className="space-y-6 animate-fadeIn">
                    ...
                    <div className="bg-gradient-to-br from-amber-800 via-amber-900 to-amber-950 text-amber-200 rounded-2xl p-5 shadow-lg relative overflow-hidden h-40 flex flex-col justify-between font-mono border border-white/5">
                      ...
                      <div className="flex justify-between items-start">
                        <span className="text-[10px] font-semibold text-white/50 tracking-widest font-sans uppercase">
                          Aura Haven Black Card
                        </span>
                      ...
                      <div className="flex justify-between text-[10px] text-white/70">
                        <div>
                          <span className="text-[8px] text-white/40 block font-sans">
                            CARDHOLDER
                          </span>
                          <span className="font-semibold tracking-wide uppercase">
                            {cardHolder || "Vamshi Raghu"}
                          </span>
                        </div>
                        <div>
                          <span className="text-[8px] text-white/40 block font-sans">
              ...
              >
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-slate-400 font-light max-w-xs mx-auto">
                    Your stay metadata has been synced with the resort automated
                    systems.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/5 rounded-2xl p-5 text-left space-y-4 max-w-md mx-auto">
                  <div className="flex justify-between items-center text-xs pb-3 border-b border-white/5">
                    ...
                    <div className="text-right">
                      ...
                      <span className="text-green-400 font-bold text-[10px] bg-green-500/10 border border-green-500/20 px-2 py-0.5 rounded-md font-mono">
                        PAID
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3.5 text-xs">
                    ...
                    <div>
                      ...
                      <span className="font-semibold text-slate-200">
                        Suite {generatedBooking.roomNumber} (
                        {generatedBooking.roomType})
                      </span>
                    </div>
                    <div>
                      <span className="text-[9px] text-slate-400 font-bold block font-mono">
                      ...
                      <span className="font-semibold text-slate-200">
                        {generatedBooking.guests} Adults
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="pt-3 border-t border-white/5 text-xs">
                      ...
                      <div className="flex flex-wrap gap-1 mt-1">
                        {generatedBooking.addons.map((ad, idx) => (
                          <span
                            key={idx}
                            className="bg-amber-500/10 border border-amber-500/25 text-amber-300 text-[10px] px-2 py-0.5 rounded-md font-medium"
                          >
                            {ad}
                          </span>
                        ))}
                  ...
                  <div className="pt-3 border-t border-white/5 flex justify-between items-center text-xs">
                    ...
                    <span className="text-lg font-bold text-white font-mono">
                      ₹{generatedBooking.totalAmount.toLocaleString("en-IN")}
                    </span>
                  </div>
                </div>
